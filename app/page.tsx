...
export default function Home() {
  ...
  return <main>
    ...
    <nav className="nav" aria-label="เมนูหลัก">
      ...
      <div className="nav-links"><button onClick={() => go("about")}>แนะนำเว็บ</button><Link href="/multimedia-basics">มัลติมีเดีย</Link><button onClick={() => go("ai")}>AI Tools</button><button onClick={() => go("courses")}>บทเรียน</button><button onClick={() => go("contact")}>ติดต่อ</button></div>
    ...
    <AnimatePresence>{menu && <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="mobile-nav"><button onClick={() => go("about")}>แนะนำเว็บ</button><Link href="/multimedia-basics">มัลติมีเดีย</Link><button onClick={() => go("ai")}>AI Tools</button><button onClick={() => go("courses")}>บทเรียน</button><button onClick={() => go("contact")}>ติดต่อ</button></motion.div>}</AnimatePresence>
